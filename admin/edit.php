<?php
// admin/edit.php - FINAL: ĐÃ XÓA NÚT "TÌNH TRẠNG KHO" (GIỮ NGUYÊN TRẠNG THÁI CŨ)
    ...
    <main class="main-content">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                ...
                <small class="text-secondary">Cập nhật thông tin</small>
            </div>
        </div>
        ...
        <form action="process.php" method="POST" enctype="multipart/form-data">
            ...
            <!-- QUAN TRỌNG: Giữ nguyên status cũ (Vì đã xóa nút gạt) -->
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-12 col-lg-5 order-lg-2">
                    <div class="form-card sticky-top" style="top: 20px; z-index: 1;">
                        <label class="form-label">1. ẢNH BÌA</label>
                        <div class="upload-box mb-3" id="thumbBox"
                            ...
                            <div id="preview-thumb" class="w-100 h-100 position-relative">
                                <!-- JS load ảnh cũ vào đây -->
                            </div>
                        </div>
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                onclick="openLibrary('thumb')">
                                <i class="ph-bold ph-image"></i> Chọn lại từ Thư viện
                            </button>
                        </div>
                        ...
                        <div class="upload-box" style="height: 100px; border-style: dashed;"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="text-secondary fw-bold">Thêm / Đổi ảnh</span>
                            </div>
                        ...
                        <div class="text-end mt-2">
                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                ...
                                <i class="ph-bold ph-stack"></i> Chọn thêm từ Thư viện
                            </button>
                        </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="radio-group">
                                <input type="radio" class="btn-check" name="type" id="typeSell" value="0"
                                    <?= $product['type'] == 0 ? 'checked' : '' ?> onchange="toggleSettings()">
                                ...
                                <input type="radio" class="btn-check" name="type" id="typeRent" value="1"
                                    <?= $product['type'] == 1 ? 'checked' : '' ?> onchange="toggleSettings()">
                        ...
                        <div class="mb-4" id="unitContainer" style="display: none;">
                            ...
                            <div class="radio-group">
                                <input type="radio" class="btn-check" name="unit" id="unitHour" value="1"
                                    <?= $product['unit'] == 1 ? 'checked' : '' ?> onchange="updatePriceLabel()">
                                <label class="radio-label" for="unitHour"><span>/ GIỜ</span></label>

                                <input type="radio" class="btn-check" name="unit" id="unitDay" value="2"
                                    <?= $product['unit'] == 2 ? 'checked' : '' ?> onchange="updatePriceLabel()">
                        ...
                        <!-- ĐÃ XÓA TOGGLE STATUS (TÌNH TRẠNG KHO) -->
