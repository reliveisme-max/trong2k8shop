<?php
// admin/login.php - UPDATE: BỎ PHÂN QUYỀN (FULL BOSS)

// 1. Cấu hình Session 30 ngày
...
if (isset($_POST['btn_login'])) {
    ...
    try {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            // --- [QUAN TRỌNG] SETUP QUYỀN MẶC ĐỊNH ---
            $_SESSION['role'] = 1;       // Luôn là Boss
            $_SESSION['prefix'] = 'MS';  // Mã mặc định cho Acc (Ví dụ MS1, MS2...)
