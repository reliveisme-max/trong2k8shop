<?php
// admin/index.php - UPDATE: NO RENT, NO FEATURED, FULL ADMIN
...
$countSold = $conn->query("SELECT COUNT(*) FROM products WHERE status = 0")->fetchColumn();
...
{
    if (empty($products)) {
        echo '<tr><td colspan="6" class="text-center py-5 text-secondary">Không tìm thấy dữ liệu</td></tr>';
        return;
    }
...
?>
        <tr>
            ...
            <td>
                ...
                <div class="d-md-none mt-1">
                    ...
                    <div class="text-muted mt-1" style="font-size: 11px;">
                        Người đăng: <?= $p['author_name'] ? $p['author_name'] : 'Admin' ?>
                    </div>
                </div>
            </td>
            ...
            <td class="d-none d-md-table-cell">
                <div class="fw-bold text-primary"><?= $p['author_name'] ?? 'Admin' ?></div>
            </td>
                ...
                <div class="col-12 col-md-6">
                    <div class="stat-card sale">
                        <div class="stat-info">
                            ...
                            <div class="stat-value"><?= number_format($countSold) ?></div>
                        </div>
